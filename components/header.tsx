  ...
  return (
    <header className=" z-[999] relative">
      <motion.div
        ...
        className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg
          ...
          {links.map((link) => (
            ...
            >
              <Link
                href={link.hash}
                className={clsx(
                  "flex justify-end items-center w-full p-3 hover:text-gray-950 transition",
                  {
